...
export default function FacultyRegisterPage() {
  ...
  const downloadTemplate = () => {
    const rows = [
      { Name: 'Rahul Sharma', 'Father/Mother Name': 'S/O Ramesh Sharma', 'Admission Number': 'ADM-001', 'Roll No.': '101', 'Class/Section': 'B.Tech 2nd Year', Course: 'Computer Science', Year: '2024–25', 'Date of Birth': '2002-05-15', 'Blood Group': 'O+', Address: '123 Main Street, City', Percentage: '85.5', Email: 'rahul@college.edu', Phone: '9876543210', 'Bus Stop': 'Main Bus Stand' },
      { Name: 'Priya Verma',  'Father/Mother Name': 'D/O Suresh Verma',  'Admission Number': 'ADM-002', 'Roll No.': '102', 'Class/Section': 'B.Tech 2nd Year', Course: 'Electronics',       Year: '2024–25', 'Date of Birth': '2003-08-22', 'Blood Group': 'A+', Address: '456 Park Avenue, Town', Percentage: '91.0', Email: 'priya@college.edu', Phone: '9876543211', 'Bus Stop': 'City Square'    },
    ];
  ...
  const handleConfirmImport = async () => {
    ...
    setImportLoading(true);
    try {
      await importStudents(previewRecords);
      setExcelFile(null);
      setBulkPhotoMap(new Map());
      setPreviewRecords(null);
      setBulkImportOpen(false);
      setNotice({ message: `${previewRecords.length} records imported successfully.`, type: 'success' });
      setTimeout(() => setNotice(null), 4000);
    } catch {
